<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"H:\phpstudy\WWW\ThinkPHP\public/../application/home\view\login\register.html";i:1515216582;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<body>
					...
					<div class="am-tabs" id="doc-my-tabs">
						...
						<div class="am-tabs-bd">
							<div class="am-tab-panel am-active">
								...
								<div class="am-cf">
									<input type="button" id="email_sub" value="注册" class="am-btn am-btn-primary am-btn-sm am-fl">
								</div>
							</div>
							<div class="am-tab-panel">
								...
								<div class="am-cf">
									<input type="button" id="phone_sub" value="注册" class="am-btn am-btn-primary am-btn-sm am-fl">
								</div>
								<hr>
							</div>
						</div>
		...
		<script src="/static/basic/js/register.js"></script>
	</body>
</html>